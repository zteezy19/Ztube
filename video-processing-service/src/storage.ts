...
const rawVideoBucketName = "ztz-yt-raw-videos";
const processedVideoBucketName = "ztz-yt-processed-videos";
...
/**
 * @param rawVideoName - The name of the file to convert from {@linklocalRawVideoPath}.
